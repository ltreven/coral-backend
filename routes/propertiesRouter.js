...
.put(authenticate.verifyUser, (req, res, next) => {
    logger.info('Routing PUT property - does nothing - need to specify the property id');
    res.statusCode = 403;
    res.end('PUT operation not supported');
})
.delete(authenticate.verifyUser, (req, res, next) => {
    logger.info('Routing DELETE property - does nothing - need to specify the property id');
    res.statusCode = 403;
